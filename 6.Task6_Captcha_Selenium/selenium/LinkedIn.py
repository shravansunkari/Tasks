...
dataframe =pd.read_csv('/home/shravankumar/Desktop/featured_attendees.csv', usecols=names)
...
user_name="email"#enter your email
...
with open('featured_attendees_data.csv','w') as csvfile:
