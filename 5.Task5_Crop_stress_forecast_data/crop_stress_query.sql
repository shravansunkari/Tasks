INSERT INTO crop_stress_forecast_data_backup 
			...
			WHERE 
				(csfd.model_date <= 20160301 ) OR 
				(csfd.model_date < 20161231-2 AND expected_harvest_date >= 20161231-2) OR 
				(csfd.model_date < fd.expected_harvest_date AND fd.expected_harvest_date < 20161231-2 );
