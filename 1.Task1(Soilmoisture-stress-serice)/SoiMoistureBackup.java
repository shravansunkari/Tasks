...
public class SoilMoistureStressService implements ISoilMoistureStressService {
	...
	protected Map<String, ISMRainfallStressData> getRFStressDataForVillages(int modelDate)
		...
		List<String> rainfallLocations = stateToRainfallLocMap
				.get("6f86292b-dd9a-4987-bb8f-c3940263b349"); /*
																 * Andhra Pradesh
																 * LocationUUID
																 */
	...
	public Map<String, Map<Integer, Double>> getSMStressRFDataForDate(
		...
		System.out.println("\n\nTime lag : Map(887) time lag  t1="+t1+" C= "+System.currentTimeMillis()+"===> "+(System.currentTimeMillis()-t1));
		...
		for (String villageName : villageSMLocDataMap.keySet()) {
			...
			for (ISMLocMapData gridData : gridsUnderVillage) {
				...
				for (IWaterQuantityEventData wqEventData :  rfLocDataList) {
					...
					//System.out.println("model data ="+modelDate+"    wqEventData.getLevelValue1()="+wqEventData.getLevelValue1());
				}
				//put in map here
				dateToLevelMap.put(modelDate,value);
				dateToGridCount.put(modelDate,count);
				//System.out.println("\n\n\nTime lag1 (967)= "+(System.currentTimeMillis()-t2)+"\n\n");
			...
			//System.out.println("\n\n\nTime lag2 Grid Level (988)= "+(System.currentTimeMillis()-t2)+"\n\n");
			
			resultMap.put(villageName, dateToLevelMap);
		}
		}
		System.out.println("\n\nTime lag : Map(993) Village Level time lag  t1="+t1+" C= "+System.currentTimeMillis()+"===> "+(System.currentTimeMillis()-t1));
		...
		for (String mandalName : mandalVillMap.keySet()) {
			...
			System.out.println("\n\n\nTime lag2 Village Level (1044)= "+(System.currentTimeMillis()-t2)+"\n\n");
		...
		System.out.println("\n\nTime lag : Map(1063) Mandal level time lag  t1="+t1+" C= "+System.currentTimeMillis()+"===> "+(System.currentTimeMillis()-t1));
